...
void mexPhidf3D(double *phidf,double *N,double *im, mwSize m, mwSize n, mwSize o,mwSize m1,mwSize n1,int step)
{
    
    int i,j,k,l,mn,count=0;
    int pix;
    double gx,gy,gz;
    mn=m*n;
    for (k=0;k<o;k+=step){
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    mexPhidf3D(phidf,N,im0,mrows0,ncols0,pstacks0,mrows1,ncols1,step);
