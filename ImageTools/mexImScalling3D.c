...
void mexScal(double *moy, double *etype, int *im0, mwSize mc, mwSize nc, mwSize oc)
{
...
etype= mxGetPr(plhs[1]);
    ...
    mexScal(moy,etype,im0,mrows0,ncols0,pstacks0);
